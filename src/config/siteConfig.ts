...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://lettery.cc.cd",

	// 站点描述
	description:
		"言以寓情，文以载道。这里是 LetterY（言信）海外信息站点之一，博客由 Hurt Luis (SummerRX) 维护，致力于记录有趣的灵魂和有用的知识，希望可以帮到你。",
